 ...
 * @property {ToggleVariant} [variant="default"]
 * @property {ToggleSize} [size="default"]
...
/**
 * A toggle button built on Radix Toggle. Supports pressed state styling.
 *
 * @param {ToggleProps & React.ComponentPropsWithoutRef<typeof TogglePrimitive.Root>} props
 * @returns {JSX.Element}
 */
function Toggle({
  className,
