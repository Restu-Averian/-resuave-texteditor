...
/**
 * @typedef {"default" | "xs" | "sm" | "lg" | "icon" | "icon-xs" | "icon-sm" | "icon-lg"} ButtonSize
 */
 ...
 * @property {ButtonVariant} [variant="default"] Visual style variant.
 * @property {ButtonSize} [size="default"] Button size variant.
 * @property {boolean} [asChild=false] Render the button as a child slot.
